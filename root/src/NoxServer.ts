...
import UnitTestController from "./controllers/UnitTestController";

class NoxServer extends Server {
  private readonly _SERVER_START_MSG = "n0.x server started on port: ";
  ...
  constructor() {
    ...
    super.addControllers(new UnitTestController());
